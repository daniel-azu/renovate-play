...
import { expectBoolean as __expectBoolean, expectNumber as __expectNumber, expectString as __expectString, } from "@aws-sdk/smithy-client";
...
var deserializeAws_json1_1FindingSeverityCounts = function (output, context) {
    return Object.entries(output).reduce(function (acc, _a) {
        ...
        return __assign(__assign({}, acc), (_b = {}, _b[key] = __expectNumber(value), _b));
    }, {});
};
