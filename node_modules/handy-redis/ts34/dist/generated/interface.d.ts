...
export interface Commands<Context extends ClientContext = {
    ...
    ], nomkstream: "NOMKSTREAM", asterisk_or_id: "*" | "ID", ...field_value: Array<[
        /*field*/ string,
        /*value*/ string
    ]>): Result<string | null, Context>;
    /**
     ...
     */
    xtrim(key: string, strategy: "MAXLEN", operator: number | [
        /*equals_or_tilde*/ "=" | "~",
        /*length*/ number
    ]): Result<number, Context>;
    /**
    ...
    ], streams: "STREAMS", key: Array<string>, ...id: Array<string>): Result<unknown, Context>;
    /**
     * Return new entries from a stream using a consumer group, or access the history of the pending entries for a given consumer. Can block.
     * - _group_: stream
     * - _complexity_: For each stream mentioned: O(M) with M being the number of elements returned. If M is constant (e.g. always asking for the first 10 elements with COUNT), you can consider it O(1). On the other side when XREADGROUP blocks, XADD will pay the O(N) time in order to serve the N clients blocked on the stream getting new data.
    ...
    ], noack: "NOACK", streams: "STREAMS", key: Array<string>, ...id: Array<string>): Result<unknown, Context>;
    /**
     * Return new entries from a stream using a consumer group, or access the history of the pending entries for a given consumer. Can block.
     * - _group_: stream
     * - _complexity_: For each stream mentioned: O(M) with M being the number of elements returned. If M is constant (e.g. always asking for the first 10 elements with COUNT), you can consider it O(1). On the other side when XREADGROUP blocks, XADD will pay the O(N) time in order to serve the N clients blocked on the stream getting new data.
