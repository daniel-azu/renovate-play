...
async function initRepo(args) {
    ...
    git = (0, simple_git_1.default)(localDir);
...
async function setUserRepoConfig({ branchPrefix, gitIgnoredAuthors, gitAuthor, }) {
...
async function isBranchStale(branchName) {
    ...
    try {
        ...
        logger_1.logger.debug({ isStale, branches, currentBranch, currentBranchSha }, `IsBranchStale=${isStale}`);
        return isStale;
    }
    catch (err) /* istanbul ignore next */ {
        checkForPlatformFailure(err);
...
async function commitFiles({ branchName, files, message, force = false, }) {
    ...
    try {
        ...
        const commitOptions = {};
        if ((0, config_1.getNoVerify)().includes("commit" /* Commit */)) {
        ...
        if ((0, config_1.getNoVerify)().includes("push" /* Push */)) {
