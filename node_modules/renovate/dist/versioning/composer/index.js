...
const getMajor = (version) => npm_1.api.getMajor((0, semver_1.coerce)(composer2npm(version)));
const getMinor = (version) => npm_1.api.getMinor((0, semver_1.coerce)(composer2npm(version)));
const getPatch = (version) => npm_1.api.getPatch((0, semver_1.coerce)(composer2npm(version)));
