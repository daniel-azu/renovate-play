...
async function fetchJSONFile(repo, fileName, endpoint) {
    let res;
    try {
        res = await (0, gitea_helper_1.getRepoContents)(repo, fileName, null, { baseUrl: endpoint });
    }
    catch (err) {
...
function getPresetFromEndpoint(pkgName, filePreset, presetPath, endpoint = exports.Endpoint) {
...
function getPreset({ packageName: pkgName, presetName = 'default', presetPath, }) {
    return getPresetFromEndpoint(pkgName, presetName, presetPath, exports.Endpoint);
}
