...
parentKey) {
    ...
    try {
        ...
        const migratedConfig = (0, clone_1.clone)(config);
        const depTypes = [
            'dependencies',
            'devDependencies',
            'engines',
        ...
        const { migratePresets } = (0, global_1.getGlobalConfig)();
        for (const [key, val] of Object.entries(config)) {
            if (removedOptions.includes(key)) {
                ...
                if (val === 'high') {
                    (_a = migratedConfig.allowCustomCrateRegistries) !== null && _a !== void 0 ? _a : (migratedConfig.allowCustomCrateRegistries = true);
                    (_b = migratedConfig.allowScripts) !== null && _b !== void 0 ? _b : (migratedConfig.allowScripts = true);
                    (_c = migratedConfig.exposeAllEnv) !== null && _c !== void 0 ? _c : (migratedConfig.exposeAllEnv = true);
                }
            }
                ...
                for (let i = 0; i < schedulesLength; i += 1) {
                    if (schedules[i].includes(' and ') &&
                        ...
                        if (((_d = parsedSchedule === null || parsedSchedule === void 0 ? void 0 : parsedSchedule.t_a) === null || _d === void 0 ? void 0 : _d[0]) > ((_e = parsedSchedule === null || parsedSchedule === void 0 ? void 0 : parsedSchedule.t_b) === null || _e === void 0 ? void 0 : _e[0])) {
            ...
            if (is_1.default.string(migratedConfig[key])) {
                for (const [from, to] of Object.entries(migratedTemplates)) {
                    migratedConfig[key] = migratedConfig[key].replace(new RegExp(from, 'g'), to);
                }
            }
        }
