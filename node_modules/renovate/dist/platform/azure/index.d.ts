...
export declare function getRawFile(fileName: string, repoName?: string): Promise<string | null>;
export declare function getJsonFile(fileName: string, repoName?: string): Promise<any | null>;
