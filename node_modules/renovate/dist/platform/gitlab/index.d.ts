...
export declare function getRawFile(fileName: string, repo?: string): Promise<string | null>;
export declare function getJsonFile(fileName: string, repo?: string): Promise<any | null>;
...
export declare function ensureIssue({ title, reuseTitle, body, labels, }: EnsureIssueConfig): Promise<'updated' | 'created' | null>;
