...
function warnOnUnsupportedOptions(config) {
    if (config.filterUnavailableUsers && !platform_1.platform.filterUnavailableUsers) {
        logger_1.logger.warn(`Configuration option 'filterUnavailableUsers' is not supported on the current platform '${config.platform}'.`);
    }
}
async function initRepo(config_) {
    ...
    await (0, git_1.setUserRepoConfig)(config);
