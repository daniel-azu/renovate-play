...
async function mergeRenovateConfig(config) {
    ...
    const decryptedConfig = (0, decrypt_1.decryptConfig)(migratedConfig);
    // istanbul ignore if
    ...
    let resolvedConfig = (0, decrypt_1.decryptConfig)(await presets.resolveConfigPresets(decryptedConfig, config));
