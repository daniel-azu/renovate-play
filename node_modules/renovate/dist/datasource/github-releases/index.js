...
async function getReleases({ lookupName: repo, registryUrl, }) {
    ...
    const sourceUrlBase = (0, common_1.getSourceUrlBase)(registryUrl);
    const apiBaseUrl = (0, common_1.getApiBaseUrl)(sourceUrlBase);
...
async function getDigest({ lookupName: repo, currentValue, currentDigest, registryUrl }, newValue) {
    ...
    const apiBaseUrl = (0, common_1.getApiBaseUrl)((0, common_1.getSourceUrlBase)(registryUrl));
