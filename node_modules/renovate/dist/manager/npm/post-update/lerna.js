...
async function generateLockFiles(lernaPackageFile, cwd, config, env, skipInstalls) {
    ...
    try {
        ...
        if ((0, global_1.getGlobalConfig)().allowScripts && config.ignoreScripts !== false) {
        ...
        const tagConstraint = await (0, node_version_1.getNodeConstraint)(config, allowUnstable);
        const execOptions = {
            cwd,
            extraEnv: {
