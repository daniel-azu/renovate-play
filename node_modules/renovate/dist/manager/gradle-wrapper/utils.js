...
const gradle_1 = __importDefault(require("../../versioning/gradle"));
...
function gradleWrapperFileName() {
    ...
    if (os_1.default.platform() === 'win32' &&
        ((_a = (0, global_1.getGlobalConfig)()) === null || _a === void 0 ? void 0 : _a.binarySource) !== 'docker') {
        return 'gradlew.bat';
    }
    return './gradlew';
}
...
function getJavaContraint(gradleVersion) {
    var _a;
    if (((_a = (0, global_1.getGlobalConfig)()) === null || _a === void 0 ? void 0 : _a.binarySource) !== 'docker') {
        // ignore
        return null;
    }
