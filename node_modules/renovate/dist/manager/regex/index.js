...
function createDependency(matchResult, combinedGroups, config, dep) {
    ...
    for (const field of validMatchFields) {
        ...
        if (config[fieldTemplate]) {
            try {
                const compiled = template.compile(config[fieldTemplate], combinedGroups !== null && combinedGroups !== void 0 ? combinedGroups : groups, false);
...
function handleCombination(content, packageFile, config) {
    ...
    const combinedGroup = matches
        ...
        .reduce((mergedGroup, currentGroup) => mergeGroups(mergedGroup, currentGroup));
