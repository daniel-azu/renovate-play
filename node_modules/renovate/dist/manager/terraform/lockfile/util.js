...
exports.writeLockUpdates = exports.isPinnedVersion = exports.extractLocks = exports.readLockFile = exports.findLockFile = void 0;
...
function findLockFile(packageFilePath) {
    return (0, fs_1.getSiblingFileName)(packageFilePath, lockFile);
}
...
function writeLockUpdates(updates, lockFilePath, oldLockFileContent) {
    ...
    updates.forEach((update, index, array) => {
        ...
        providerBlockLines.forEach((providerBlockLine, providerBlockIndex) => {
            const versionLine = providerBlockLine.replace(versionLineRegex, `$1${update.newVersion}$3`);
            if (versionLine !== providerBlockLine) {
                newProviderBlockLines.push(versionLine);
                return;
            }
            const constraintLine = providerBlockLine.replace(constraintLineRegex, `$1${update.newConstraint}$3`);
