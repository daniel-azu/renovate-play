...
function extractPackageFile(content) {
    ...
    try {
        ...
        for (let lineNumber = 0; lineNumber < lines.length; lineNumber += 1) {
            ...
            if (terraformDependency) {
                ...
                const tfDepType = (0, util_1.getTerraformDependencyType)(terraformDependency.groups.type);
                let result = null;
                switch (tfDepType) {
    ...
    deps.forEach((dep) => {
        switch (dep.managerData.terraformDependencyType) {
            case common_1.TerraformDependencyTypes.required_providers:
                (0, required_providers_1.analyzeTerraformRequiredProvider)(dep);
                break;
            case common_1.TerraformDependencyTypes.provider:
                (0, providers_1.analyzeTerraformProvider)(dep);
                break;
            case common_1.TerraformDependencyTypes.module:
