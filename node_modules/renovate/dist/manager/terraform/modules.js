...
exports.analyseTerraformModule = exports.extractTerraformModule = exports.gitTagsRefMatchRegex = exports.githubRefMatchRegex = void 0;
...
exports.githubRefMatchRegex = /github\.com([/:])(?<project>[^/]+\/[a-z0-9-_.]+).*\?ref=(?<tag>.*)$/i;
exports.gitTagsRefMatchRegex = /(?:git::)?(?<url>(?:http|https|ssh):\/\/(?:.*@)?(?<path>.*.*\/(?<project>.*\/.*)))\?ref=(?<tag>.*)$/;
